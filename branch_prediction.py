...
# Set up CPU as X86O3CPU to get ILP-related stats
system.cpu = X86O3CPU()

# Add a branch predictor (e.g., TournamentBP or BiModeBP)
system.cpu.branchPred = TournamentBP()  # Tournament Branch Predictor

# Alternatively,to use BiMode branch predictor:
...
# Path to the correct 'hello' binary
...
# Create a process for the hello binary
process = Process()
process.cmd = [binary]
...
print(f"Starting simulation with binary: {binary}")
