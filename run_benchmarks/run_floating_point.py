...
# Path to the floating-point benchmark binary
floating_point_benchmark = "/Users/aanik_tmg/Downloads/gem5/configs/test1/benchmarks/floating_point_benchmark"
...
# Set up the workload
system.workload = SEWorkload.init_compatible(floating_point_benchmark)
process = Process()
process.cmd = [floating_point_benchmark]
...
print("Starting floating-point benchmark...")
